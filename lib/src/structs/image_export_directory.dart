...
class IMAGE_EXPORT_DIRECTORY extends Struct {
  ...
  @Uint32()
  external int AddressOfFunctions; // RVA from base of image
  @Uint32()
  external int AddressOfNames; // RVA from base of image
  @Uint32()
  external int AddressOfNameOrdinals; // RVA from base of image
}
